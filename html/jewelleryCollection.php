...
$sql = "SELECT * FROM products WHERE mainCatagory = 'jewellery' ORDER BY RAND()";
...
<section class="main-home">
    <div class="main-text">
        <h1> WOMENS <br><span>COLLECTION</span></h1>
    </div>
</section>
                    ...
                    <li class="item-a">
                        <div class="box">
                            ...
                            <div class="details-box">
                                <div class="type">
                                    <a href="oneitem.html?id=<?php echo $producID ?>"><?php echo $title; ?></a>
